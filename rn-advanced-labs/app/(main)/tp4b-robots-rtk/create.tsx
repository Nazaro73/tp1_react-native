...
import { selectRobotsLoading, selectRobotsError } from '../../../features/robots/selectors';
import { useThemeColor } from '@/hooks/use-theme-color';
import { createShadow } from '../../../utils/shadows';
import { RobotType, type RobotInput, type RobotTypeValue } from '../../../validation/robotSchema';

export default function TP4BRobotsCreate() {
  ...
  const handleSubmit = async () => {
    ...
    console.log('➕ [TP4B-Create] Création via Redux:', formData);
    ...
    try {
      ...
      console.log('✅ [TP4B-Create] Robot créé avec succès');
      router.back();
    } catch (error) {
      console.error('❌ [TP4B-Create] Erreur création:', error);
      Alert.alert('Erreur', typeof error === 'string' ? error : 'Erreur lors de la création');
    }
  };

  const handleCancel = () => {
    console.log('❌ [TP4B-Create] Annulation création');
    router.back();
  };
  ...
  return (
    <ThemedView style={styles.container}>
      ...
      >
        ...
        >
          {/* Header */}
          <ThemedText style={styles.title}>Nouveau Robot</ThemedText>
            ...
            <View style={styles.buttonContainer}>
              ...
              >
                <ThemedText style={styles.submitButtonText}>
                  {isLoading ? 'Création...' : 'Créer le robot'}
                </ThemedText>
              </TouchableOpacity>
            </View>
